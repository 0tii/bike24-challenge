...
interface ShopSuccessIconProps extends SVGProps<SVGSVGElement> {}

export const ShopSuccessIcon = ({ fill, ...props }: ShopSuccessIconProps) => {
  return (
    <svg
...
export default ShopSuccessIcon;
